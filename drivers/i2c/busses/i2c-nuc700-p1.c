/* linux/drivers/i2c/busses/i2c-nuc700-p1.c
 *
...
#define I2CCSR		REG_I2CCSR1
#define I2CDIVIDER	REG_I2CDIVIDER1
#define I2CCMDR		REG_I2CCMDR1
#define I2CSWR		REG_I2CSWR1
#define I2CRXR		REG_I2CRXR1
#define I2CTXR		REG_I2CTXR1

/* i2c driver static defination */
static int i2c1_irq;
static struct clk *clk;

enum nuc700_i2c_port1_state {
        STATE_IDLE,
        STATE_START,
        STATE_READ,
        STATE_WRITE,
...
struct nuc700_i2c_port1 {
        ...
        enum nuc700_i2c_port1_state	state;
        void __iomem		*regs;
        struct clk			*clk;
        struct device		*dev;
        struct resource		*irq;
...
static inline void nuc700_i2c_master_complete(struct nuc700_i2c_port1 *i2c, int ret)
{
...
static inline void nuc700_i2c_disable_irq(struct nuc700_i2c_port1 *i2c)
{
        __raw_writel(0x00, I2CCSR);
}

static inline void nuc700_i2c_enable_irq(struct nuc700_i2c_port1 *i2c)
{
...
static void nuc700_i2c_message_start(struct nuc700_i2c_port1 *i2c,
                                     struct i2c_msg *msg)
{
...
static inline void nuc700_i2c_stop(struct nuc700_i2c_port1 *i2c, int ret)
{
        /* stop the transfer */
...
static int i2c_irq_nextbyte(struct nuc700_i2c_port1 *i2c, unsigned long iiccsr)
{
        unsigned char byte;
        int ret = 0;
...
{
        struct nuc700_i2c_port1 *i2c = dev_id;
...
static int nuc700_i2c_set_master(struct nuc700_i2c_port1 *i2c)
{
        int timeout = 400;
...
static int nuc700_i2c_doxfer(struct nuc700_i2c_port1 *i2c, struct i2c_msg *msgs, int num)
{
...
{
        struct nuc700_i2c_port1 *i2c = (struct nuc700_i2c_port1 *)adap->algo_data;
        int retry;
        int ret;
...
static struct nuc700_i2c_port1 nuc700_i2c = {
...
static int nuc700_i2c_init(struct nuc700_i2c_port1 *i2c)
{
...
static void nuc700_i2c_free(struct nuc700_i2c_port1 *i2c)
{
        free_irq(i2c1_irq, i2c);
	clk_disable(clk);	
	clk_put(clk);
}
...
{
        struct nuc700_i2c_port1 *i2c = &nuc700_i2c;
        int ret;
	...
	i2c1_irq = platform_get_irq(pdev, 0);
	if (i2c1_irq < 0) {
		dev_err(&pdev->dev, "failed to get i2c0 irq\n");
		return -ENXIO;
	}
        ret = request_irq(i2c1_irq, nuc700_i2c_irq,
...
{
        struct nuc700_i2c_port1 *i2c = platform_get_drvdata(pdev);
...
MODULE_DESCRIPTION("nuc700 I2C1 driver");
MODULE_LICENSE("GPL");
MODULE_ALIAS("platform:nuc700-i2c-p1");
