/*
 * linux/arch/arm/mach-nuc700/time.c
 *
...
static unsigned long nuc700_gettimeoffset(void)
{
	return 0;
}
...
static void __init nuc700_timer_init(void)
{
	nuc700_timer_setup();
	setup_irq(IRQ_TIMER0, &nuc700_timer_irq);
}

struct sys_timer nuc700_timer = {
	.init		= nuc700_timer_init,
	.offset		= nuc700_gettimeoffset,
	.resume		= nuc700_timer_setup
};
